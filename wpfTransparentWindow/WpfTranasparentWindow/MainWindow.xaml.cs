...
namespace WpfTranasparentWindow
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void SetNotification()
        {
            ...
            Stream iconStream = App.GetResourceStream(new Uri("pack://application:,,,/WpfTranasparentWindow;component/ex.ico")).Stream;
        ...
        private void SetWindowExTransparent()
        {
            foreach(var win in App.Current.Windows)
            {
                if (win is PokemonWindow pokemonWindow)
                    pokemonWindow.SetWindowExTransparent();
                if(win is DrawWindow drawWindow)
