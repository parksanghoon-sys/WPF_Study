...
namespace WpfTranasparentWindow
{
    ...
    public partial class DrawWindow : Window
    {
        ...
        {
            InitializeComponent();
            this.Loaded += DrawWindow_Loaded;
            this.xCanvas.PreviewMouseLeftButtonDown += Canvas_PreviewMouseLeftButtonDown;
        ...
        internal void SetWindowExTransparent()
        {
