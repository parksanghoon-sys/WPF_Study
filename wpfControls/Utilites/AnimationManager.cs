...
namespace wpfControls.Utilites
{
    public class AnimationManager
    {
        ...
        private readonly Lazy<Storyboard> _storyboardLazy
            = new(() => new Storyboard());
        private readonly Lazy<DoubleAnimation> _doubleAnimationLazy
            = new(() => new DoubleAnimation());
        private readonly Lazy<ThicknessAnimation> _thicknessAnimationLazy
            = new(() => new ThicknessAnimation());
        ...
        public void  SetLeftProperty(double from, double to, double ms)
        {
        ...
        public void SetMarginProperty(Thickness from, Thickness to, double ms)
        {
            Storyboard.Children.Clear();
            ThicknessAnimation.From = from;
            ThicknessAnimation.To = to;
            this.DoubleAnimation.Duration = TimeSpan.FromMilliseconds(ms);
