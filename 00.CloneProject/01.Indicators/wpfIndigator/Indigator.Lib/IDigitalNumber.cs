...
{
    /// <summary>
    /// 수치형 값을 디지털 문자들로 표시하는 인데게이터이다.
    /// </summary>
    public interface IDigitalNumber : IDigitalIndicator
    {
        /// <summary>
        /// 표시할 정수 자리 개수를 가져오거나 설정
        /// </summary>
        int IntegerDigits { get; set; }
        /// <summary>
        /// 표시할 소수 자리 갯수를 가져오거나 설정
        /// </summary>
        int DecimalPlaces { get; set; }
        /// <summary>
        /// 디지털 문자 세로크기 대비 소수점 크기 비율을 가져오거나 설정
        /// </summary>
        double DecimalSeparatorSize { get; set; }
        /// <summary>
        /// 디지털 문자 세로크기 대비 소수 자리 문자의 크기 비율을 가져오거나 설정
        /// </summary>
